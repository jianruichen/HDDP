...
# 1.dataset
parser.add_argument('--dataset', type=str, default='ncrna', help='datasets')
...
# 2.experiments
parser.add_argument('--max_epoch', type=int, default=2000, help='number of epochs to train.')
...
parser.add_argument('--weight_decay', type=float, default=5e-5, help='weight for L2 loss on basic models.')
...
if args.dataset in ['B-dataset', 'F-dataset', 'm-dataset', 'drug-1']:
    args.testlength = 3
