...
class HGATConv(nn.Module):
    ...
    def forward(self, x, edge_index, c):
        ...
        h = self.agg.forward(h, edge_index, c)
...
class HypLinear(nn.Module):
    ...
    def __init__(self, manifold, in_features, out_features, c, dropout=0.6, use_bias=True):
        ...
        self.fc = HGNN_classifier(in_features, in_features)
    ...
    def forward(self, x, c):
        ...
        mv = self.manifold.mobius_matvec(drop_weight, x, c)
        ...
        if self.use_bias:
            ...
            res = self.manifold.mobius_add(res, hyp_bias, c=c)
...
class GATLayer(nn.Module):
    def __init__(self, edim):
        ...
        self.a=Parameter(torch.FloatTensor(32, 32), requires_grad=True)
...
class HypAct(Module):
    ...
    def forward(self, x, c):
        ...
        return self.manifold.proj(self.manifold.expmap0(xt, c), c)
...
class HypAttAgg(MessagePassing):
    ...
    def forward(self, x, edge_index, c):
        ...
        x_tangent0 = self.manifold.logmap0(x, c)  # project to origin
        ...
        support_t = self.manifold.proj(self.manifold.expmap0(support_t, c), c)
